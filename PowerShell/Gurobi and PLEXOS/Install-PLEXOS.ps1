#Install PLEXOS (filename is always the same name)
Start-Process msiexec -ArgumentList "/i PLEXOS_Setup_x64.msi /qn /norestart" -NoNewWindow -Wait -ErrorAction SilentlyContinue
#Update Gurobi License Files on all installations found locally
#Set download path and URLs:
New-Item -Path "C:\Software\GurobiFix" -ItemType Directory -Force -ErrorAction SilentlyContinue
$DownloadPath91 = "C:\Software\GurobiFix\gurobi91.lcr"
$DownloadPath95 = "C:\Software\GurobiFix\gurobi95.lcr"
$DownloadPath100 = "C:\Software\GurobiFix\gurobi100.lcr"
$DownloadPath110 = "C:\Software\GurobiFix\gurobi110.lcr"
$DownloadPath120 = "C:\Software\GurobiFix\gurobi120.lcr"
